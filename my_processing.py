...
Pipeline:
    load -> grayscale -> binarize (3 methods to compare) -> resize/pad to 28x28 -> normalize

Setup (only needs to be done once):
    pip install pillow numpy

Usage:
    python my_preprocessing.py --image digit.png --method otsu --out result.png
    python my_preprocessing.py --image digit.png --compare compare.png
    python my_preprocessing.py --image digit.png --stages stages.png
"""
